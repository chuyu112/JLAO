...
DEFAULT_VLM_PROMPT = (
    ...
    "- object_style: 手镯/珠串/珠链/蛋面/戒指/吊坠/耳饰/摆件/其他\n"
    "- transparency: 不透/微透/半透/高透\n"
    "- grain: 无明显/轻微/明显/很粗\n"
    "- texture_fineness: 细腻/中等/粗\n"
    "- luster: 弱/中/强\n"
    "- shape_theme: 无/观音/佛公/平安扣/如意/叶子/山水/貔貅/葫芦/无事牌/财神/龙牌/福瓜/福豆/其他\n"
    "- confidence: 0-100整数\n"
)
EMPTY_VALUES = {
    "",
...
def legacy_style_from_text(value: Any) -> str:
    ...
    catalogs = {
        ...
        "蛋面": ("蛋面", "戒面", "戒面石", "鸽子蛋", "裸石"),
        "戒指": ("戒指", "戒托", "戒圈"),
        "吊坠": ("吊坠", "挂件", "坠子", "牌子", "牌型", "龙牌", "山水牌", "无事牌", "平安扣", "扣子", "怀古", "观音", "佛公", "叶子", "如意", "葫芦", "福瓜", "福豆", "貔貅"),
        "耳饰": ("耳饰", "耳环", "耳坠", "耳钉"),
        "摆件": ("摆件", "把件", "手把件"),
    }
